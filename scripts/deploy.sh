...
# --- Configuration ---
INSTANCE_DNS="52.87.188.73"      # <<< REPLACE WITH YOUR ACTUAL EC2 INSTANCE PUBLIC IP ADDRESS
SSH_USER="ec2-user"                      # SSH username for the EC2 instance
SSH_KEY_PATH="deductly-key"              # Path to your private SSH key relative to this script
ECR_REPO_URI="538125082622.dkr.ecr.us-east-1.amazonaws.com/deductly"
CONTAINER_NAME="deductly"
IMAGE_TAG="latest"
